...
comment:
As extra tasks, I added data augmentation as ~3500 images are too small dataset for deep learning. I also performed train/val data split, which was not among the project task but it usually is a good practice to avoid overfitting and choose the stop point. I also save checkpoint only at the best epochs accord to validation.
